			...
			<CardContent className="py-2">
				<div className="grid grid-cols-4 gap-2">
					<div className="text-center">
						...
						<div
							className={`text-lg font-semibold ${getPerformanceColor(alpha.sharpe_ratio, "sharpe_ratio")}`}
						>
					...
					<div className="text-center">
						...
						<div
							className={`text-lg font-semibold ${getPerformanceColor(alpha.annualized_return, "annualized_return")}`}
						>
					...
					<div className="text-center">
						...
						<div
							className={`text-lg font-semibold ${getPerformanceColor(alpha.calmar_ratio, "calmar_ratio")}`}
						>
					...
					<div className="text-center">
						...
						<div
							className={`text-lg font-semibold ${getPerformanceColor(alpha.max_drawdown, "max_drawdown")}`}
						>
				...
				<div className="mt-1 grid grid-cols-2 gap-2 text-sm">
					<div>
						...
						<span className="ml-1 font-medium">
							{(alpha.volatility * 100).toFixed(1)}%
						</span>
					</div>
					<div>
